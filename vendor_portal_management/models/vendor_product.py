...
class vendor_product(models.Model):
    ...
    def return_import_configs(self):
        ...
        vendor_pharma_help = IPsudo.get_param('vendor_pharma_help', '')
        vendor_capital_help = IPsudo.get_param('vendor_capital_help', '')
        vendor_medical_help = IPsudo.get_param('vendor_medical_help', '')
        ...
        pharma_attach =  IPsudo.get_param('vendor_pharma_import_id', '')
        medical_attach =  IPsudo.get_param('vendor_medical_import_id', '')
        capital_attach =  IPsudo.get_param('vendor_capital_import_id', '')
        ...
        pharma_table = pharma_attach and '/web/content/{}?download=true'.format(pharma_attach) or False
        medical_table = medical_attach and '/web/content/{}?download=true'.format(medical_attach) or False
        capital_table = capital_attach and '/web/content/{}?download=true'.format(capital_attach) or False
        ...
        return {
            ...
            "vendor_pharma_help": vendor_pharma_help or False,
            "vendor_medical_help": vendor_medical_help or False,
            "vendor_capital_help": vendor_capital_help or False,
    ...
    @api.model
    def import_product_pharma_portal(self, values):
        ...
        if not values.get("basis"):
            ...
            partner_id = self.env.user.partner_id.commercial_partner_id.id
            import_wizard = self.env["vendor.pharma.import"].create({
    ...
    @api.model
    def import_product_medical_portal(self, values):
        ...
        if not values.get("basis"):
            ...
            archive_products = not import_chosen_lines and values.get("archive_products") or False
            partner_id = self.env.user.partner_id.commercial_partner_id.id
            import_wizard = self.env["vendor.medical.import"].create({
                "partner_id": partner_id,
                "table_to_import": values.get("basis"),
                "import_chosen_lines": import_chosen_lines,
                "lines_start": lines_start,
    ...
    @api.model
    def import_product_capital_portal(self, values):
        ...
        if not values.get("basis"):
            ...
            archive_products = not import_chosen_lines and values.get("archive_products") or False
            partner_id = self.env.user.partner_id.commercial_partner_id.id
            import_wizard = self.env["vendor.capital.import"].create({
                "partner_id": partner_id,
                "table_to_import": values.get("basis"),
                "import_chosen_lines": import_chosen_lines,
                "lines_start": lines_start,
