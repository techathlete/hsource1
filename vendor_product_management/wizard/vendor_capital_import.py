...
class vendor_capital_import(models.TransientModel):
    ...
    def _process_import(self):
        ...
        # 2
        fields = [
                  "id","labeler","product_code","mfg_product_code","product_name","description","lot_number","available_date",
        ...
        for val in values:
            ...
            if not product_code or not product_name:
                errors.append(
                    _(u"There is no UDC/GTIN Code or Product Description defined on line {} after the header. Line is skipped;".format(line_num))
                )
                continue
            if not location:
                errors.append(
            ...
            pr_values = {
                ...
                "labeler": labeler,
                "description": description, "lot_number": lot_number, "available_date": available_date,
